...
import { CodecEntry } from '@observertc/client-monitor-js';
...
export type CodecEntryProps = {
	entry: CodecEntry;
	next: Setter<ClientMonitorEntryRender>;
}

const CodecEntryCmp: Component<CodecEntryProps> = (props: CodecEntryProps) => {
